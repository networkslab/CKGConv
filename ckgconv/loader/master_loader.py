...
from ckgconv.loader.split_generator import (prepare_splits,
                                            set_dataset_splits)
from ckgconv.transform.posenc_stats import compute_posenc_stats, ComputePosencStat
from ckgconv.transform.transforms import (pre_transform_in_memory,
...
def preformat_OGB_Graph(dataset_dir, name):
    ...
    if name == 'ogbg-ppa':
        ...
        from ckgconv.loader.ogbg_code2_utils import idx2vocab, \
...
def preformat_Peptides(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary.
        from ckgconv.loader.dataset.peptides_functional import \
            PeptidesFunctionalDataset
        from ckgconv.loader.dataset.peptides_structural import \
